...
const Create = () => {
    ...
    return (
        <div className='flex flex-col items-center p-5 md:px-24 lg:px-36 mt-20'>
            ...
            <p className='text-grey-500 text-lg'>Fill All details in order to generate study material for your next project</p>

            <div className='mt-10'>
                {step === 0 ? <SelectOption selectStudyType={(value) => handleUserInput('courseType', value)} />
