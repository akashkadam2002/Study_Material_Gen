    ...
    return (
        <div className='mt-10'>
            <h2 className='font-bold text-2xl flex justify-between items-center'>Your Study Material
                <Button variant="outline" onClick={GetCourseList} className="border-primary text-primary" > <RefreshCcw/> Refresh</Button>
            </h2>

            <div className='grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 mt-6 gap-8'>
